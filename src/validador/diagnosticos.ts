...
export const ERRORS: Record<string, ErrorDef> = {
    ...
    'S-016': { descripcion: 'Declarar fuera de su contexto (nómina de declaración o parámetro)', severity: 'error' },
    ...
    'M-006': { descripcion: 'Tipo inválido en el parámetro de una función (Declarar ... Como)', severity: 'error' },
